...
AUTH_CHANNEL.append(949235812)
AUTH_CHANNEL.append(OWNER_ID)
# chunk size that should be used with requests
CHUNK_SIZE = int(os.environ.get("CHUNK_SIZE", "128"))
# default thumbnail to be used in the videos
DEF_THUMB_NAIL_VID_S = os.environ.get(
    "DEF_THUMB_NAIL_VID_S", "https://telegra.ph/file/f85368e0d990477d020e7.png"
)
...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "")
...
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", ""
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "True")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "")
